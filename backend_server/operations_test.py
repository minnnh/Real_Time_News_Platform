...
def test_getNewsSummariesForUser_basic():
    news = operations.getNewsSummariesForUser('user_test_eamil_3@test.com', 1)
    assert len(news) > 0
    print(news)
    print('test_getNewsSummariesForUser_basic passed')

def test_getNewsSummariesForUser_pagination():
    news_page_1 = operations.getNewsSummariesForUser('user_test_eamil_3@test.com', 1)
    news_page_2 = operations.getNewsSummariesForUser('user_test_eamil_3@test.com', 2)
